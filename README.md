...
This tutorial outlines the post-install configuration of the open-source help desk ticketing system osTicket.</a><br /> This tutorial assumes that you have completed the installation of osTicket lab.
</p>
